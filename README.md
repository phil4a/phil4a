...
- **[aeromir.su](https://aeromir.su)** — корпоративный сайт инжиниринговой компании. Занимался поддержкой, рефакторингом и развитием фронтенд-части сайта, оптимизацией интерактивных элементов, сложных форм заказа и интерфейса взаимодействия с клиентами. Сейчас в процессе переноса на Nuxt(Vue) + Strapi CMS
  - **Стек:** JavaScript (ES6+), SCSS (BEM), Gulp, Wordpress.
